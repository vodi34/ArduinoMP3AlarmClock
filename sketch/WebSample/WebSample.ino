...
UTFT     myGLCD(ILI9486, A5, A4, A3, A2); //Parameters should be adjusted to your Display/Schield model

URTouch  myTouch( 6, 5, 4, 3, 2);


SoftwareSerial mp3Serial(10, 11);  // RX, TX
DFRobotDFPlayerMini mp3;  // creating an instance of class DFRobotDFPlayerMini and call it 'mp3'
...
void setup() {
  ...
  Serial.begin(115200);  // set serial monitor baud rate to Arduino IDE
  ...
  // ALT mp3.setup(mp3Serial); // tell BY8001 library which serial port to use.
...
// Updates the track bar
void trackPlayTime() {
  totalTime = 300; //mp3.getTotalTrackPlaybackTime();
  delay(10);
  elapsedTime = 150; //mp3.getElapsedTrackPlaybackTime();
  delay(10);
